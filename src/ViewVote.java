...
public class ViewVote extends JFrame implements ActionListener {
    ...
    public void  viewVote(){
        ...
        String[] column={"Serial","Name","Votes"};
        ...
        for (int i = 0; i < candidateInfo.serial.size(); i++) {
            ...
            String vote = candidateInfo.list.get(i).toString();
            model.addRow(new Object[]{serial, name, vote});
        }
